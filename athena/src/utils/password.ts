...
import HashSaltCombo from "../interfaces/service/HashSaltCombo.interface"

/**
 * Hashes a password with a salt
 * @param password The password to be hashed
 * @param salt The salt to be used when hashing
 * @returns A promise that either resolves to a structure consisting of a hash and a salt, or rejects to null.
 */
